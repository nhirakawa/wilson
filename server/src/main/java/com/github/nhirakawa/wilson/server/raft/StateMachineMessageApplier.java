...
public class StateMachineMessageApplier {
  ...
  public synchronized AppendEntriesResponse apply(AppendEntriesRequest appendEntriesRequest) {
    WilsonState updatedWilsonState = wilsonStateReference.updateAndGet(wilsonState -> applyAppendEntriesRequest(wilsonState, appendEntriesRequest));
  ...
  private WilsonState applyAppendEntriesRequest(WilsonState wilsonState, AppendEntriesRequest appendEntriesRequest) {
