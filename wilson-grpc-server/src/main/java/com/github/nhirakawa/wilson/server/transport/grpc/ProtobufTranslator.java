...
final class ProtobufTranslator {
  ...
  public AppendEntriesRequest fromProto(
    AppendEntriesRequestProto appendEntriesRequestProto
  ) {
  ...
  public AppendEntriesRequestProto toProto(
    AppendEntriesRequest appendEntriesRequest
  ) {
    return objectMapper.convertValue(
      appendEntriesRequest,
      AppendEntriesRequestProto.class
    );
  }

  public AppendEntriesResponse fromProto(
    AppendEntriesResponseProto appendEntriesResponseProto
  ) {
    return objectMapper.convertValue(
  ...
  public AppendEntriesResponseProto toProto(
    AppendEntriesResponse appendEntriesResponse
  ) {
    return objectMapper.convertValue(
      appendEntriesResponse,
      AppendEntriesResponseProto.class
    );
  }
